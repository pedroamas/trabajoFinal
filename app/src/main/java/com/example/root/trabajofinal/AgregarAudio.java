...
public class AgregarAudio extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_agregar_audio);
        ...
        btnSubir.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                progress = new ProgressDialog(AgregarAudio.this);
               ...
               // progress.show();
                ...
                Thread t = new Thread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        Log.e("Path del audio",f.getPath());
                        ...
                        Request request = new Request.Builder()
                                .url("http://pedroamas.xyz/subir_audio.php")
                                .post(request_body)
                                .build();
        ...
        btnUpload.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                new MaterialFilePicker()
                        .withActivity(AgregarAudio.this)
                        .withRequestCode(10)
                        .start();
