...
public class VerVideoEliminarComentario extends AppCompatActivity
    ...
    private static int EDITAR_VIDEO = 4000;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        contenido.addView(getLayoutInflater().inflate(R.layout.activity_ver_video_eliminar, null));
        configurarMenu();
        ...
        btnEditarVideo.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(context, DetalleEditarVideo.class);
                intent.putExtra("id",idVideo);
                startActivityForResult(intent,EDITAR_VIDEO);
            }
        });
        ...
        Button btnEliminarVideo=(Button)findViewById(R.id.btnEliminarVideo);
        btnEliminarVideo.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                builder.setMessage(Html.fromHtml("<font color='#000000'>¿Desea eliminar el video?</font>"));
                //builder.setTitle("Eliminar");
                builder.setPositiveButton("Eliminar", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int which) {

                        gestorMultimedia.eliminarImagenSec(idVideo, new EliminarImagenSecListener() {
                            @Override
                            public void onResponseEliminarImagenSecListener(String response) {
                                if(response.equals("Ok")){
                                    Toast.makeText(context,"El video ha sido borrado correctamente",
                                            Toast.LENGTH_LONG).show();
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.btnActualizar) {
            ...
            progress = new ProgressDialog(VerVideoEliminarComentario.this);
